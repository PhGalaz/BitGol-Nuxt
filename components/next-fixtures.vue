<template>
  <v-row
    class="ma-0 pa-0 titulo"
    style="width:100%;border-radius:2px;inset:-3px"
  >
    <subtitle
      class="ma-0 mt-1 pa-0 ops"
      title='<< PREV 100'
      style="height:100%;color:#ccc;max-width:120px"
    />
    <v-spacer></v-spacer>
    <subtitle
      class="ma-0 mt-1 mr-5 pa-0 justify-end ops"
      title='NEXT 100 >>'
      style="height:100%;color:#ccc;max-width:120px"
      justify="rigth"
    />
      <v-row
        class="ma-0 mx-1 mt-1 pa-0"
        style="width:100%;height:30px;background-color:#1C1C1C;border-radius:2px 2px 2px 2px"
        justify="center"
      >
    ...
    <v-row
      ...
      style="max-height:50vh;max-width:100%;overflow:auto;;border-radius:0px 10px 0px 0px"
    >
